...
jQuery( function( $ ) {
  ...
  var cartIsOK = function(clickedButton) {
    ...
    if (isAGift(variationId) && !isEmptyCart()) {
      alert('Votre panier contient d\'autres produits. Les abonnements que vous offrez doivent faire l\'objet d\'une commande séparée.');
      // TODO: put a toaster
      return false;
    }
    ...
    if (subscriptionAlreadyInCart() && isASubscription(clickedButton.data('product_id'))) {
      alert('Il y a déjà un abonnement dans votre panier. Merci de compléter une commande par abonnement.');
      // TODO: put a toaster
      return false;
    }
    return true;
